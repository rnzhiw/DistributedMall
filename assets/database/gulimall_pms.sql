...
INSERT INTO `pms_category` VALUES (165, '电子书111', 22, 3, 1, 1, NULL, NULL, 0);
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 72 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu属性值' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_product_attr_value` VALUES (70, 18, 7, '入网型号', 'A2217', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (71, 18, 8, '上市年份', '2019', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku信息' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_sku_info` VALUES (27, 18, 'huawei 黑色 4GB', NULL, 225, 9, 'https://gulimall-hello.oss-cn-beijing.aliyuncs.com/2019-11-27/299481e9-4704-4824-8b18-60c7d268353c_7ae0120ec27dc3a7.jpg', 'huawei 黑色 4GB', '', 5499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (28, 18, 'huawei 白色 4GB', NULL, 225, 9, 'https://gulimall-hello.oss-cn-beijing.aliyuncs.com/2019-11-27/299481e9-4704-4824-8b18-60c7d268353c_7ae0120ec27dc3a7.jpg', 'huawei 白色 4GB', '', 6799.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 57 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_sku_sale_attr_value` VALUES (53, 27, 9, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (54, 27, 10, '内存', '4GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (55, 28, 9, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (56, 28, 10, '内存', '4GB', NULL);
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 97 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu图片' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_spu_images` VALUES (96, 18, NULL, 'https://gulimall-rnzhiw.oss-cn-shanghai.aliyuncs.com/2021-09-21/7538f7f5-029d-480a-82e0-087efbea4442_1f15cdbcf9e1273c.jpg', NULL, NULL);
...
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (11, '华为 HUAWEI Mate 30 Pro', '华为 HUAWEI Mate 30 Pro', 225, 9, 0.1980, 1, '2019-11-26 10:10:57', '2021-09-26 09:45:20');
INSERT INTO `pms_spu_info` VALUES (13, ' Apple iPhone 11 (A2223) ', ' Apple iPhone 11 (A2223) ', 225, 12, 0.1940, 1, '2019-11-27 05:37:30', '2021-09-26 09:45:23');
INSERT INTO `pms_spu_info` VALUES (14, 'aaa', 'aaa', 225, 9, 0.0000, 0, '2021-09-24 15:12:25', '2021-09-24 15:12:28');
INSERT INTO `pms_spu_info` VALUES (15, '华为 mate 30 pro', '华为 mate 30 pro', 225, 9, 0.0000, 0, '2021-09-24 15:12:50', '2021-09-24 15:12:52');
INSERT INTO `pms_spu_info` VALUES (18, 'huawei', 'huawei', 225, 9, 0.0000, 1, '2021-09-21 02:34:39', '2021-09-26 09:42:59');
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu信息介绍' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_spu_info_desc` VALUES (15, 'https://gulimall-rnzhiw.oss-cn-shanghai.aliyuncs.com/2021-09-21/75d688ec-ec1f-4807-8833-acf273e535b2_0d40c24b264aa511.jpg');

...
-- ----------------------------
INSERT INTO `sms_seckill_session` VALUES (1, '8:00', '2021-11-10 07:02:59', '2021-11-30 23:00:00', 1, '2021-11-09 09:02:25');
INSERT INTO `sms_seckill_session` VALUES (2, '10:00', '2021-11-10 14:55:59', '2021-11-30 03:00:00', 1, '2021-11-09 09:03:12');
INSERT INTO `sms_seckill_session` VALUES (3, '11:00', '2021-11-10 13:17:57', '2021-11-19 13:18:06', 1, '2021-11-10 13:18:15');
...
CREATE TABLE `sms_seckill_sku_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '秒杀活动商品关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_seckill_sku_relation
-- ----------------------------
INSERT INTO `sms_seckill_sku_relation` VALUES (1, NULL, 1, 1, 1, 1, 1, 1);
INSERT INTO `sms_seckill_sku_relation` VALUES (2, NULL, 2, 2, 2, 2, 2, 2);
INSERT INTO `sms_seckill_sku_relation` VALUES (4, NULL, 1, 2, 998, 10, 1, 1);
INSERT INTO `sms_seckill_sku_relation` VALUES (5, NULL, 3, 3, 10, 100, 1, 1);
...
CREATE TABLE `sms_spu_bounds`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品spu积分设置' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
INSERT INTO `sms_spu_bounds` VALUES (1, 17, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (2, 18, 0.0000, 0.0000, NULL);
